...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_item'])) {
    ...
    $sql = "INSERT INTO lunch (item_name, cuisine_type, price) VALUES ('$item_name', '$cuisine_type', $price)";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit_item'])) {
    ...
    $sql = "UPDATE lunch SET item_name = '$item_name', cuisine_type = '$cuisine_type', price = $price WHERE id = $item_id";
    if (mysqli_query($conn, $sql)) {
...
if (isset($_GET['delete_id'])) {
    $item_id = (int)$_GET['delete_id'];
    $sql = "DELETE FROM lunch WHERE id = $item_id";
    if (mysqli_query($conn, $sql)) {
...
$sql = "SELECT * FROM lunch WHERE item_name LIKE '%$search%' OR cuisine_type LIKE '%$search%'";
$result = mysqli_query($conn, $sql);

// Fetch item for editing
$item_to_edit = [];
if (isset($_GET['edit_id'])) {
    $item_id = (int)$_GET['edit_id'];
    $sql = "SELECT * FROM lunch WHERE id = $item_id";
...
<head>
    <title>The Gallery Café | Lunch</title>
