...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_item'])) {
    ...
    $sql = "INSERT INTO breakfast (item_name, cuisine_type, price) VALUES ('$item_name', '$cuisine_type', $price)";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit_item'])) {
    ...
    $sql = "UPDATE breakfast SET item_name = '$item_name', cuisine_type = '$cuisine_type', price = $price WHERE id = $item_id";
    if (!mysqli_query($conn, $sql)) {
        echo "Error: " . mysqli_error($conn);
    }
}
...
if (isset($_GET['delete_id'])) {
    ...
    $sql = "DELETE FROM breakfast WHERE id = $item_id";
    if (!mysqli_query($conn, $sql)) {
        echo "Error: " . mysqli_error($conn);
    }
}
...
$sql = "SELECT * FROM breakfast WHERE item_name LIKE '%$search%' OR cuisine_type LIKE '%$search%'";
...
if (isset($_GET['edit_id'])) {
    ...
    $sql = "SELECT * FROM breakfast WHERE id = $item_id";
    $result = mysqli_query($conn, $sql);
    if ($result) {
...
<head>
    <title>The Gallery Café | Breakfast</title>
